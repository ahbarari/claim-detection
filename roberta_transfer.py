...
with open(f'thesis-codebase/metrics/{train_prefix}_roberta_evaluation_results_{current_time}.txt', 'w') as f:
  f.write(str(results))  
...
with open(f'thesis-codebase/metrics/{train_prefix}_roberta_evaluation_results_{current_time}_cm.txt', 'w') as f:
